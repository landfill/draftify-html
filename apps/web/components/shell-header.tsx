    ...
    <header className="c-header">
      ...
      <div className="c-header-right">
        ...
        {/*
          ...
          비로그인 상태에서도 보여 준다: 로그인 없이 랜딩·가이드를 읽던 사람에게도 작업을
          시작할 길이 있어야 한다. 비로그인이면 `/login`, 로그인 상태면 콘솔 홈 `/`을
          가리킨다 — `/`가 공개 랜딩이 된 뒤에도 [내 프로젝트]가 자기 페이지로 되돌아가지
          않게 하는 분기다 (이슈 #85).
