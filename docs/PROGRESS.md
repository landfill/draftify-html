...
**▶ 다음 세션 시작점 (2026-07-31 갱신) — #63·#68·#65·#77 프로덕션 반영 완료. #64(문서 현행화)·#70(`§` 표기)은 **PR #79 리뷰·병합 대기**(문서만 변경, 코드 0줄). 그 다음 후보는 #71(공개판 로딩 지연).**
...
- **열린 이슈** — 처리 순서는 위 "다음 할 일":
  ...
  - **#70** 문서의 `§` 기호를 '절'로 풀어쓰기 — **PR #79 대기** (856곳 치환 + AGENTS.md 표기 규약 신설)
  - **#64** 문서 인덱스·작업 규약 현행화 — **PR #79 대기** (guide 7종 목록화·읽는 순서에 user-guide 추가·docs/README 세 경로 반영·`apps/web/README.md` 신설)
  ...
  - **#12 · #13** `[실수요 대기]` 유지
  - 종결: **#77(PR #78)**, **#65(PR #76)**, **#68(PR #75)**, **#63(PR #72)**, #43(PR #67), #47(PR #58), #50·#51(PR #53), #34·#36·#42(이전 세션)
...
### 2026-07-31 — #64 문서 인덱스·규약 현행화 + #70 `§` 표기 정리 (PR #79 — 리뷰·병합 대기)

- 완료: **PR #79** (브랜치 `docs/index-conventions-and-section-notation-64-70`), 커밋은 이슈별로 분리(`2feef25` #64 / `089fdc4` #70). **문서만 변경 — 코드 0줄.**
- **#64 (4개 완료 조건 전부)**:
...
- 다음 할 일: **PR 리뷰(CodeRabbit·Codex) 반영 → 사용자 동의 후 병합.** 병합 후 남은 우선순위 후보는 **#71**(공개판 로딩 지연).
- 막힌 지점: 없음.
