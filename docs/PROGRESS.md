...
**▶ 다음 세션 시작점 (2026-07-31 갱신) — #63·#68·#65 프로덕션 반영 완료. 다음 작업은 사용자 우선순위 지정 대기(후보: #71 성능, #64 문서 현행화, #70 표기 정리).**
...
- **열린 이슈** — 처리 순서는 위 "다음 할 일":
  ...
  - **#77** 가이드·FAQ에서 프로젝트 목록으로 돌아갈 길이 **로고뿐** — 처음 쓰는 사람이 못 찾는다 (사용자 지적, 2026-07-31). 헤더 내비에 콘솔 링크 추가, 공개판·사내판 양쪽. **선행 결정 3건**: 비로그인 노출 여부(`/`는 보호 경로라 누르면 `/login`으로 튄다)·라벨("내 프로젝트" vs "콘솔")·좁은 화면 접힘
  ...
  - **#12 · #13** `[실수요 대기]` 유지
  - 종결: **#65(PR #76)**, **#68(PR #75)**, **#63(PR #72)**, #43(PR #67), #47(PR #58), #50·#51(PR #53), #34·#36·#42(이전 세션)
