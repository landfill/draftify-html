...
**▶ 다음 세션 시작점 (2026-08-01 갱신) — #71 **완료·종결**(PR #80, merge `1ec760a`). 함수 리전을 `icn1`로 고정해 콘솔 홈 목록 표시가 **7.1초 → 0.92초**. 남은 최적화(RSC 프리페치)는 **#81로 분리**했다. 다음 작업은 사용자 우선순위 지정 대기 — 후보는 **#46**(매직링크, 결정만 하면 풀린다)·**#81**(프리페치).**
...
- **열린 이슈** — 처리 순서는 위 "다음 할 일":
  ...
  - **#12 · #13** `[실수요 대기]` 유지
  - 종결: **#71(PR #80)**, #64·#70(PR #79), #77(PR #78), #65(PR #76), #68(PR #75), #63(PR #72), #43(PR #67), #47(PR #58), #50·#51(PR #53), #34·#36·#42(이전 세션)
