...
**▶ 다음 세션 시작점 (2026-08-01 갱신) — 성능 3건(#71·#82·#81) 완료·종결·프로덕션 반영. 콘솔 홈 목록 표시가 **7.1초 → 0.59초**.**

**다음 작업은 사용자가 새로 등록한 디자인 2건이다 (2026-08-01, 착수 대기):**

- **#85 공개판 메인 화면** — 비로그인 진입이 `/login`으로 튕겨 **서비스 소개 지점이 없고**, 로그인 후 첫 화면은 업로드 폼이 목록을 아래로 민다. 랜딩 신설 vs `/` 비로그인 상태 활용은 **착수 시 결정**
