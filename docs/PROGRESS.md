...
**용어 개정(표면 "장면"→"화면"·"전이"→"화면 이동", 킥오프 §11 10차) — PR #2로 main 병합 완료 (2026-07-12, CI green·rebase). 다음: 후속 판단 잔여(스크린샷 fallback·작성자 라벨·옵션 S·뷰어 세로 스크롤 내부화 제안 답변 대기) 또는 S3. 새 세션은 여기서 시작.**
