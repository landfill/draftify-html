...
**▶ 다음 세션 시작점 (2026-07-31 갱신) — #63·#68 프로덕션 반영 완료. 다음 작업 = #65(가이드 터미널 UI), 결정은 이미 받아 뒀다(항상 다크 + 출력 포함).**
...
- **열린 이슈** — 처리 순서는 위 "다음 할 일":
  ...
  - **#65** 사용 가이드 코드 예시를 터미널 창 UI로 — **다음 착수. 선행 결정 완료 (사용자, 2026-07-31): ① 테마와 무관하게 항상 다크, ② 예시에 실제 명령 출력을 포함**(그래야 성공 초록·주의 노랑 색 구분이 장식에 그치지 않는다). 스타일은 공개판·사내판 양쪽 CSS에 함께 넣는다
  ...
  - **#12 · #13** `[실수요 대기]` 유지
  - 종결: **#68(PR #75)**, **#63(PR #72)**, #43(PR #67), #47(PR #58), #50·#51(PR #53), #34·#36·#42(이전 세션)
