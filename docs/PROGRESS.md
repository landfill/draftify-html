...
- **열린 이슈** — 처리 순서는 위 "다음 할 일":
  ...
  - **#105** `storage_object_owned_by_user`를 anon이 실행할 수 있다 — **신규 등록 (2026-08-06, #57 조사에서 분리).** 의도는 authenticated 전용인데 실제 ACL에 anon·service_role이 있다. **영향은 낮다**(anon은 `auth.uid()`가 null이라 항상 false 반환) 단 advisor 0028이 WARN으로 남는다. 조치는 `revoke execute ... from anon;` 한 줄이지만 **프로덕션 권한 변경이라 사용자 동의가 선행**한다. 적용하면 `schema.sql`의 "의도≠실제" 주석도 함께 지운다
  ...
  - **#12 · #13** `[실수요 대기]` 유지
  - 종결: **#57(PR #107)**, **#103(PR #104)**, **#99(PR #102)**, **#90(main 직접 `79ae30e`·`e5d111c`)**, **#97(PR #100)**, **#87 T87-14(PR #101)**, **#86(PR #98)**, **#91(PR #96)**, **#93(PR #95)**, **#87(PR #92·#94)**, **#85(PR #88)**, **#81(PR #84)**, **#82(PR #83)**, **#71(PR #80)**, #64·#70(PR #79), #77(PR #78), #65(PR #76), #68(PR #75), #63(PR #72), #43(PR #67), #47(PR #58), #50·#51(PR #53), #34·#36·#42(이전 세션)
